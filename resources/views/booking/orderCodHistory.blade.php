    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Total Order COD History</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/booking-dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Order COD History</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">{{ $today_price ?? 0.0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">{{ $OrderCodToDay ?? 0.0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span
                                                            class="info-box-number">{{ $today_price - $OrderCodToDay ?? 0.0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">{{ $total_price ?? '0.0' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text"><strong>Submit COD</strong></span>
                                                        <span class="info-box-number">{{ $OrderCodTotal ?? 0.0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text"><strong>Pending COD</strong></span>
                                                        <span
                                                            class="info-box-number">{{ $total_price - $OrderCodTotal ?? 0.0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card card-light">
                                ...
                                <form id="codAmount">
                                    <div class="mb-3">
                                        <input type="text" name="refNo" id="refNo"
                                            class="form-control form-control-sm" placeholder="Enter Ref. No.">
                                    </div>
                            ...
                            <div class="card-body">
                                <table class="table table-sm">
                                    ...
                                    <tbody id="bodyData">
                                        @include('booking.inc.orderCodHistory')
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#codAmount').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('booking.orderCodAmount') }}",
                    type: 'POST',
                    data: {
                        refNo: refNo,
                        amount: amount,
