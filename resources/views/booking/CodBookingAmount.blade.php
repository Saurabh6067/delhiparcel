...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>My Cod Sattlement</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/booking-dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Cod Sattlement</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bold">Cod Sattlement Amount</h3>
    ...
    @foreach ($data as $item)
        @if ($item->d_amount != 0) <!-- Skip records where d_amount is 0 -->
            <tr>
                <td>{{ $sr++ }}</td>
                <td>{{ $item->datetime }}</td>
                <td>{{ $item->d_amount ?? '-' }}</td>
                <td class="text-uppercase">
                    ...
                    @else
                        @if ($item->msg == 'credit')
                            Debit
                        @elseif ($item->msg == 'debit') <!-- Corrected typo: 'credit' to 'debit' -->
                             Credit
                        @else
                            {{ $item->msg }}
                        @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--    </div>-->
                    <!--</form>-->
                    <form method="POST" action="{{ route('booking.addWalletAmount') }}">
                        @csrf
                        <div class="input-group mb-3">
