...
@push('scripts')
    ...
    <script>
        ...
        function updatePrice() {
            ...
            document.getElementById('amount').setAttribute('data-amount', totalPrice);
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#codInput').on('change', function() {
                let price = parseFloat($('#amount').data('amount')) || 0;
            ...
            function updateTotalAmount() {
                let basePrice = parseFloat($('#amount').data('amount')) || 0;
