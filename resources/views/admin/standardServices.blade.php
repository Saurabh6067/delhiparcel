    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Manage Standard Services</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('admin-dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Add Standard Services</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="type" id="servicesType" class="form-control">
                                                    <option value="ss"
                                                        @if (!empty($singleService) && $singleService->type == 'ss') selected @endif>
                                                        Regular</option>
                                                    <option value="stss"
                                                        @if (!empty($singleService) && $singleService->type == 'stss') selected @endif>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Standard Services</h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="bodyData">
                                        @include('admin.inc.standardServices')
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#serviceForm").on("submit", function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.addStandardServices') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
