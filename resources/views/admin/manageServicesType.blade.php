    ...
    <script>
        ...
        $(document).ready(function() {
            $('#services').on('change', function(e) {
                ...
                if (services == 'ss') {
                    $('#servicesType').html(
                        '<option>Select</option><option value="ss">Regular</option><option value="stss">Stander</option>'
                    );
                } else if (services == 'ex') {
                    $('#servicesType').html(
                        '<option>Select</option><option value="ex">Regular</option><option value="stex">Stander</option>'
                    );
                } else if (services == 'se') {
                    $('#servicesType').html(
                        '<option>Select</option><option value="se">Regular</option><option value="stse">Stander</option>'
                    );
                } else {
                    $('#servicesType').html('');
                }
