    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Branch COD History</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/admin-dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item">Branch COD History</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-primary">
                                            ...
                                            <form id="allCodAmount">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="daterange"
                                                        id="reservation" data-id="{{ request()->segment(2) }}">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="bodyData">
                                        @include('admin.inc.branchALLCodHistory')
                                    </tbody>
                                    <tfoot>
                                        <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#reservation').on('change', function() {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url: "{{ route('admin.branch.date.COD.history') }}",
                    type: 'GET',
                    data: {
                        date: date,
                        id: id
