...
<head>
    ...
    /* Add similar styles for home_btn */
    #home_btn {
        display: inline-flex;
        align-items: center;
        justify-content: center;
...
<body>
    <div>
            ...
            <div class="label">
                <table>
                    ...
                    <tr>
                        ...
                        @php
                            $price = preg_replace('/[^0-9.]/', '', $data->codAmount ?? '');
       ...
       <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px; width: 500px;">
            ...
            <a href="https://delhiparcel.nilet.in" class="btn btn-primary" id="home_btn">
                Home
            </a>
    ...
    <script>
        ...
        function downloadPDF(divName) {
            ...
            html2pdf().from(element).save(`${ordderId}.pdf`);
        }
