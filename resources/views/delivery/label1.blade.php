                    ...
                    <tr>
                        ...
                        <td class="center bold">
                            ...
                            {{ 
                                ...
                                (($data->service_type ?? '') === 'SuperExpress' ? 'SuperExpress' : 'Standard') 
                            }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <strong>Sender:</strong> {{ $data->sender_name ?? $data->order->fullname }} | {{ $data->sender_number ?? $data->order->phoneno }} <br>
