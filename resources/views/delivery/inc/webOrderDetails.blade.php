@foreach ($data as $key => $value)
    <tr>
        ...
        <td class="text-center">
            <a href="{{ url('/delivery-invoice/' . $value->order_id) }}" title="Order Invoice" target="_blank"
        ...
        <td> <span class="text-uppercase">{{ $value->payment_methods }}</span></td>
        <td>
            ...
            @elseif($value->order_status == 'Delivered')
                <span class="badge badge-success" title="{{ $value->status_message }}">{{ $value->order_status }}</span>
