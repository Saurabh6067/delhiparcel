                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody id="bodyData">
                                        @include('delivery.inc.webOrderDetails')
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".status", function() {
                ...
                $.ajax({
                    url: "{{ route('delivery.DirectOrdersStatus.get') }}",
                    type: "POST",
                    data: {
                        id: id
                    },
            ...
            $(document).on("click", ".assign", function() {
                const id = $(this).data('id');
                $.ajax({
                    url: "{{ route('delivery.DirectOrdersAssign.get') }}",
                    type: "POST",
                    data: {
                        id: id
                    },
            ...
            $(document).on("submit", '#assignForm', function(e) {
                ...
                $.ajax({
                    url: "{{ route('delivery.DirectOrdersAssign.add') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#reservation').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('delivery.DirectOrdersFilter') }}",
                    type: 'GET',
                    data: {
                        date: date
                    },
