...
@section('main')
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-light">
                            <div class="card-header">
                                <h3 class="card-title">This Year's Earnings ({{ \Carbon\Carbon::now('Asia/Kolkata')->startOfYear()->format('d-m-Y') }} to {{ \Carbon\Carbon::now('Asia/Kolkata')->endOfYear()->format('d-m-Y') }})</h3>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered table-striped earnings-table" id="yearEarnings">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Amount</th>
                                    ...
                                    <tbody>
                                        @forelse ($earningsData['this_year']['orders'] as $index => $order)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>₹{{ $orderRate }}</td>
                                                <td>{{ $order->datetime }}</td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4">No earnings for this year.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="total">Total Earnings (This Year): ₹{{ $earningsData['this_year']['total'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal for Submitting COD to Branch (Unchanged) -->
...
@push('scripts')
    ...
    <script>
        $(function () {
            ...
            // Handle COD form submission (unchanged)
