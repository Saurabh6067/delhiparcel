    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Delivery Boy Setting</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/delivery-boy-dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Delivery Boy Setting</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center"><b>Phone No:</b> {{ $data->phone }}</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
    ...
    <script>
        $(document).ready(function() {
            $("#updateProfile").on("submit", function(e) {
                ...
                $.ajax({
                    url: "{{ route('delivery.boy.update.profile') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#passwordChange").on("submit", function(e) {
                ...
                let formData = new FormData(this);
                $.ajax({
                    url: "{{ route('delivery.boy.passwordChange') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
