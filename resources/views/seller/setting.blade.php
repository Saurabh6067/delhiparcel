                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Seller Setting</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center"><b>Full Address:</b> {{ $data->fulladdress }}</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="adminName" name="adminName"
                                                        placeholder="Full Name" value="{{ $data->fullname }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form class="form-horizontal" id="passwordChange">
                                            ...
                                            <div class="form-group row">
                                                <div class="offset-sm-2 col-sm-10">
                                                    <button type="submit" class="btn btn-danger" id="changePassword">Change
                                                        Password</button>
                                                </div>
                                            </div>
                                        </form>
    ...
    <script>
        $(document).ready(function () {
            $("#updateProfile").on("submit", function (e) {
                ...
                $.ajax({
                    url: "{{ route('seller.update.profile') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#passwordChange").on("submit", function (e) {
                ...
                let formData = new FormData(this);
                $.ajax({
                    url: "{{ route('seller.passwordChange') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
