    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('seller.allOrders') }}" class="nav-link">
                ...
                {{-- <li class="nav-item ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('seller.addDeliveryBoy') }}" class="nav-link ">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Delivery Boy</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('seller.allDeliveryBoy') }}" class="nav-link ">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    <a href="{{ route('seller.orderCodHistory') }}" class="nav-link">
                        <i class="nav-icon fas fa-solid fa-money-bill"></i>
                        <p>
                            Order COD History
                        </p>
