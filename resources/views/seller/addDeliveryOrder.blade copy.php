...
@push('style')
    <style>
        ...
        button.express-btn.selected,
button.standard-btn.selected {
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12 col-lg-6 d-flex">
                                                    <div class="form-check">
                                                        <input class="form-check-input m-1 me-1" type="radio" id="cod" name="payment_methods" value="COD" onchange="updatePrice()" required>
                                                ...
                                                <div class="col-12 col-lg-6 d-flex">
                                                    <div class="form-check">
                                                        <input class="form-check-input m-1" type="radio" id="online" name="payment_methods" value="online" onchange="updatePrice()" required>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12 d-flex">
                                                    <div class="mb-3 form-check">
                                                        <input class="form-check-input m-1" type="checkbox" name="insurance" id="insurance" value="Yes" onchange="updatePrice()">
                                                        <label class="form-check-label" for="insurance">
                                                            Do you want to insurance your order? <em class="text-success" style="font-size: 12px;">
...
<script>
    $(document).ready(function() {
        ...
        // Show/hide COD input and handle payment validation
        ...
        // Update price when COD input changes
    ...
    function updateTotalCost() {
        ...
        var codCharge = parseFloat($('#codChargeValue').text()) || 0;
