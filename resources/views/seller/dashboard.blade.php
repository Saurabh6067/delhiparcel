            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('seller.allOrders') }}" class="small-box-footer">More info <i
                    ...
                    {{-- <div class="col-lg-3 col-6">
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('seller.allDeliveryBoy') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div> --}}
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('seller.wallet') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{ route('seller.setting') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-secondary">
                            ...
                            <a href="{{ route('seller.allCodHistory') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'toDayOrder') }}" class="text-dark">
                            <div class="info-box">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'toDayPendingOrder') }}" class="text-dark">
                            <div class="info-box">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'toDayOrderPicUp') }}" class="text-dark">
                            <div class="info-box">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'toDayCompleteOrder') }}" class="text-dark">
                            <div class="info-box">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'toDayCancelledOrder') }}" class="text-dark">
                            <div class="info-box">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'totalOrder') }}" class="text-dark">
                            <div class="info-box">
                                <span class="info-box-icon bg-primary"><i class="fas fa-box"></i></span>
                                <div class="info-box-content">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'totalPendingOrder') }}" class="text-dark">
                            <div class="info-box">
                                <span class="info-box-icon bg-success"><i class="fas fa-hourglass"></i></span>
                                <div class="info-box-content">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'totalOrderPicUp') }}" class="text-dark">
                            <div class="info-box">
                                <span class="info-box-icon bg-warning"><i class="fas fa-hourglass"></i></span>
                                <div class="info-box-content">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'totalCompleteOrder') }}" class="text-dark">
                            <div class="info-box">
                                <span class="info-box-icon bg-secondary"><i class="far fa-check-circle"></i></span>
                                <div class="info-box-content">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <a href="{{ url('/order-details/' . 'totalCancelledOrder') }}" class="text-dark">
                            <div class="info-box">
                                <span class="info-box-icon bg-danger"><i class="fas fa-solid fa-dolly"></i></span>
                                <div class="info-box-content">
