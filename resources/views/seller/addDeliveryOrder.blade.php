                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-4 d-flex">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="online">Prepaid
                                                            Order</label>
                                                    </div>
                                                </div>
                                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Payment method change handler
                ...
                if ($('#cod').is(':checked')) {
                    ...
                    updateTotalAmount(); // Update total after resetting COD
                }
            });
        ...
        function get_price(button) {
            // Remove active ID from all express-btn buttons
        ...
        // Remove unused updateTotalCost function as it duplicates logic
        function updateTotalCost() {
            // This function is redundant with updateTotalAmount and can cause confusion.
            // We're using updateTotalAmount exclusively for consistency.
            updateTotalAmount();
        }
    </script>
@endpush